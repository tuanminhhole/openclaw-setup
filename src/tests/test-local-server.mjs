...
import { createBotInProject, deleteBotInProject, readBotCredentials } from '../server/local-server.js';

const server = readFileSync(new URL('../server/local-server.js', import.meta.url), 'utf8');
