/* ============================================
   ...
   ============================================ */
// AUTO-GENERATED by build.mjs â€” edit files in setup/ instead
...
(function () {
  ...
  *Generated by OpenClaw Setup*
  ...
  // â”€â”€ Shared workspace scaffold helpers for wizard + CLI (setup/shared/scaffold-gen.js) 
  (function (root) {
  ...
  // â”€â”€ Shared runtime docs, browser, uninstall helpers for wizard + CLI (setup/shared/runtime-gen.js) 
  // @ts-nocheck
  (function (root) {
  ...
  // â”€â”€ generateGatewayStartBat, generateGatewayStartNohup, generateGatewayStartPm2 (setup/generators/gateway-start-gen.js) 
  // @ts-nocheck
  /* eslint-disable no-undef, no-unused-vars */
  /**
   * @fileoverview Part of the OpenClaw Setup Wizard IIFE bundle.
  ...
  // â”€â”€ generateOutput + generateNativeScript + ZIP + clipboard (setup/ui/output.js) 
  // @ts-nocheck
  /* eslint-disable no-undef, no-unused-vars */
  /**
   * @fileoverview UI layer — part of the OpenClaw Setup Wizard IIFE bundle.
